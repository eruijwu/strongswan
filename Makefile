...
ACLOCAL = ${SHELL} /home/eruijwu/code/test/strongswan/missing aclocal-1.15
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
ATOMICLIB = 
AUTOCONF = ${SHELL} /home/eruijwu/code/test/strongswan/missing autoconf
AUTOHEADER = ${SHELL} /home/eruijwu/code/test/strongswan/missing autoheader
AUTOMAKE = ${SHELL} /home/eruijwu/code/test/strongswan/missing automake-1.15
AWK = gawk
BFDLIB = 
BTLIB = 
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -Wall -Wno-pointer-sign -Wno-format-security -Wno-format -mno-ms-bitfields -I/home/eruijwu/code/ppfu/build-root/install-vpp_debug-native/vpp/include -include /home/eruijwu/code/test/strongswan/config.h
COVERAGE_CFLAGS = 
COVERAGE_LDFLAGS = 
CPP = gcc -E
CPPFLAGS = 
...
LDFLAGS = -L/home/eruijwu/code/ppfu/build-root/install-vpp_debug-native/vpp/lib
LEX = flex
LEXLIB = -lfl
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/eruijwu/code/test/strongswan/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MYSQLCFLAG = 
MYSQLCONFIG = 
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/eruijwu/code/test/strongswan
abs_srcdir = /home/eruijwu/code/test/strongswan
abs_top_builddir = /home/eruijwu/code/test/strongswan
abs_top_srcdir = /home/eruijwu/code/test/strongswan
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
aikgen_plugins =  sha2 sha1 md5 mgf1 random nonce x509 pubkey pkcs1 pem openssl gmp
am__include = include
am__leading_dot = .
am__quote = 
am__tar = tar --format=ustar -chf - "$$tardir"
am__untar = tar -xf -
attest_plugins =  sha2 sha1 md5 mgf1 random x509 pkcs1 pkcs8 pem openssl gmp
...
build_vendor = pc
builddir = .
c_plugins =  attr load-tester kernel-libipsec kernel-netlink resolve socket-default socket-dynamic stroke vici updown eap-identity eap-sim eap-sim-file eap-aka eap-aka-3gpp2 xauth-generic lookip counters
charon_natt_port = 4500
charon_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random nonce x509 revocation constraints pubkey pkcs1 pkcs7 pkcs8 pkcs12 pgp dnskey sshkey pem openssl fips-prf gmp curve25519 xcbc cmac ctr gcm attr load-tester kernel-libipsec kernel-netlink resolve socket-default socket-dynamic stroke vici updown eap-identity eap-sim eap-sim-file eap-aka eap-aka-3gpp2 xauth-generic lookip counters
charon_udp_port = 500
clearsilver_LIBS = 
cmd_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random nonce x509 revocation constraints pubkey pkcs1 pkcs7 pkcs8 pkcs12 sshkey pem openssl fips-prf gmp curve25519 xcbc cmac ctr gcm kernel-libipsec kernel-netlink resolve socket-default socket-dynamic eap-identity xauth-generic
datadir = ${datarootdir}
...
install_sh = ${SHELL} /home/eruijwu/code/test/strongswan/install-sh
ipsec_script = ipsec
...
manager_plugins =  sha1 random pkcs1 pkcs8 pem openssl gmp
mandir = ${datarootdir}/man
medsrv_plugins =  sha2 sha1 mgf1 random pkcs1 pkcs8 pem openssl gmp
mkdir_p = $(MKDIR_P)
nm_CFLAGS = 
nm_LIBS = 
nm_ca_dir = /usr/share/ca-certificates
nm_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random nonce x509 revocation constraints pkcs1 pkcs7 pkcs8 sshkey pem openssl fips-prf gmp curve25519 xcbc cmac ctr gcm kernel-netlink socket-default eap-identity
...
pki_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random x509 revocation pubkey pkcs1 pkcs7 pkcs8 pkcs12 dnskey sshkey pem openssl gmp curve25519
...
s_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random nonce x509 revocation constraints pubkey pkcs1 pkcs7 pkcs8 pkcs12 pgp dnskey sshkey pem openssl fips-prf gmp curve25519 xcbc cmac ctr gcm
sbindir = ${exec_prefix}/sbin
scepclient_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random x509 pkcs1 pkcs7 pkcs8 pkcs12 pem openssl gmp
scripts_plugins =  aes des rc2 sha2 sha1 md5 mgf1 random x509 pkcs1 pkcs7 pkcs8 pkcs12 pem openssl gmp curve25519 ctr gcm
...
strongswan_options =  charon charon-logging starter scepclient pki swanctl
swanctldir = ${prefix}/etc/swanctl
